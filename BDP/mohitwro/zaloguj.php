...
<body>
	<header>
		<div class="logwin">
			<div class="logwin">
				<a href='rejestracja.php'><img src='img/plus.jpg' height='13px'/><span style='margin-left: 5px;'>Zarejestruj się</span></a>
	...
	<div class="oknolog">
		...
		<div class="formco"><h2>Login</h2></div><input type="text" name="login"/>
		<div class="formco"><h2>Haslo</h2></div><input type="password" name="haslo"/>
